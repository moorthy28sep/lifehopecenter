    ...
    <footer className="bg-[#0a2744] text-white">
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-white/60 text-xs font-semibold tracking-widest">CENTER</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+91892139004" className="text-white font-semibold hover:text-[#4db6e8] transition-colors">
                    +91892139004
                  </a>
                </div>
              </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-white/40 text-sm">© 2024 Life Hope Center. All rights reserved.</p>
