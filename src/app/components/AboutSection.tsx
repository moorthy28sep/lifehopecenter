        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-6 text-base leading-relaxed">
              Life Hope Center is a premier lifestyle and wellness destination in Thiruvananthapuram, Kerala. We combine modern medical expertise with time-tested natural therapies to help you achieve lasting health transformation.
            </p>
